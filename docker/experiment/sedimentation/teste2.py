...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      # create a new 'Clip'
      clip1 = Clip(Input=cavp1_1xmf)
      clip1.ClipType = 'Plane'
      clip1.Scalars = ['POINTS', 'pressure']
      clip1.Value = 0.12239234877247375
      ...
      slice1.SliceType.Origin = [0.5, 0.5, 0.75]
      ...
      plotOverLine1.Source.Point1 = [0.0, 0.5000000003372841, 0.75]
      plotOverLine1.Source.Point2 = [1.0, 0.5000000003372841, 0.75]
    return Pipeline()
