  ...
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterView(renderView1,
          filename='volume_%t.png', freq=1, fittoscreen=0, magnification=1, width=1160, height=838, cinema={})
      ...
      output_1xmfDisplay.Representation = 'Volume'
...
def DoCoProcessing(datadescription):
    ...
    print "[CATALYST] Visualization (Volume)  - Time step: " + str(timeStep) + " ; Time: " + str(time)
