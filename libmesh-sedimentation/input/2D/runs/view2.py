...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraPosition = [10.0, 1.0, 10000.0]
      renderView1.CameraFocalPoint = [10.0, 1.0, 0.0]
      renderView1.CameraParallelScale = 6.42345200177473
      ...
      coprocessor.RegisterView(renderView1,
          filename='necker_%t.png', freq=1, fittoscreen=1, magnification=1, width=1003, height=498, cinema={})
