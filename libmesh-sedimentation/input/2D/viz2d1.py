...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraParallelScale = 5.325782446549621
      ...
      coprocessor.RegisterView(renderView1,
          filename='necker2d_%t.png', freq=1, fittoscreen=1, magnification=1, width=1141, height=624, cinema={})
      ...
      sLUTColorBar.Position = [0.29149122807017547, 0.22747191011235954]
      sLUTColorBar.Position2 = [0.4299999999999997, 0.11999999999999991]
