...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraPosition = [9.610965744259866, 0.12719179391446575, 10000.0]
      renderView1.CameraFocalPoint = [9.610965744259866, 0.12719179391446575, 0.0]
      renderView1.CameraParallelScale = 3.840750481767472
      ...
      coprocessor.RegisterView(renderView1,
          filename='necker2d_%t.png', freq=1, fittoscreen=0, magnification=1, width=1121, height=415, cinema={})
      ...
      sLUTColorBar.Position = [0.22714285714285692, 0.17359903381642516]
      sLUTColorBar.Position2 = [0.4299999999999999, 0.11999999999999988]
