...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraParallelScale = 3.6737893174779868
      ...
      coprocessor.RegisterView(renderView1,
          filename='NeckerAMR_%t.png', freq=1, fittoscreen=0, magnification=1, width=1591, height=624, cinema={})
      ...
      sLUTColorBar.Position = [0.27677591298000137, 0.7633467094703044]
      sLUTColorBar.Position2 = [0.4300000000000007, 0.12000000000000166]
