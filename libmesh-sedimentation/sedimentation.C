...
int main (int argc, char** argv)
{
  ...
  equation_systems.parameters.set<Real> ("Us")          = infile( "Us", 0.0);

  /////// 
  equation_systems.parameters.set<Real> ("xlock")       = infile( "xlock", 1.0);
  equation_systems.parameters.set<Real> ("alfa")        = infile( "alfa", 1.0);
  equation_systems.parameters.set<Real> ("theta")       = infile( "theta", 0.5);
  equation_systems.parameters.set<Real> ("ex")          = infile( "ex", 0.0);
  equation_systems.parameters.set<Real> ("ey")          = infile( "ey", 0.0);
  equation_systems.parameters.set<Real> ("ez")          = infile( "ez",-1.0);
  equation_systems.parameters.set<Real> ("c_factor")    = infile( "c_factor",1.0);
  ////
