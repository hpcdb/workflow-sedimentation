...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.CameraParallelScale = 5.267000838727966
      ...
      coprocessor.RegisterView(renderView1,
          filename='image_%t.png', freq=1, fittoscreen=1, magnification=1, width=1003, height=498, cinema={})
      ...
      #out_4xmfDisplay.OSPRayScaleArray = 'u'
      ...
      out_4xmfDisplay.SelectScaleArray = 'u'
      ...
      #out_4xmfDisplay.SetScaleArray = ['POINTS', 'u']
      #out_4xmfDisplay.ScaleTransferFunction = 'PiecewiseFunction'
      #out_4xmfDisplay.OpacityArray = ['POINTS', 'u']
