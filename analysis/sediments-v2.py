...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView1.ViewSize = [809, 813]
      renderView1.InteractionMode = '2D'
      renderView1.AxesGrid = 'GridAxes3DActor'
      renderView1.CenterOfRotation = [8.99999988079071, 0.000999927520751953, 1.00000000745058]
      renderView1.StereoType = 0
      renderView1.CameraPosition = [9.0, 10000.001, 1.0]
      renderView1.CameraFocalPoint = [9.0, 0.00100000001490116, 1.0]
      ...
      coprocessor.RegisterView(renderView1,
          filename='image_%t.png', freq=1, fittoscreen=0, magnification=1, width=809, height=813, cinema={})
