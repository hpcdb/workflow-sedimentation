...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libDfA-CPP.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libDfA-CPP.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

${OBJECTDIR}/attribute.o: attribute.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/attribute.o attribute.cpp

${OBJECTDIR}/dataflow.o: dataflow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dataflow.o dataflow.cpp

${OBJECTDIR}/dataset.o: dataset.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dataset.o dataset.cpp

${OBJECTDIR}/dependency.o: dependency.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dependency.o dependency.cpp

${OBJECTDIR}/element.o: element.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/element.o element.cpp

${OBJECTDIR}/extractor.o: extractor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extractor.o extractor.cpp

${OBJECTDIR}/set.o: set.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/set.o set.cpp

${OBJECTDIR}/task.o: task.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/task.o task.cpp

${OBJECTDIR}/transformation.o: transformation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/transformation.o transformation.cpp
...
${TESTDIR}/tests/dataflow_test.o: tests/dataflow_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dataflow_test.o tests/dataflow_test.cpp
...
${OBJECTDIR}/attribute_nomain.o: ${OBJECTDIR}/attribute.o attribute.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/attribute_nomain.o attribute.cpp;\
	else  \
...
${OBJECTDIR}/dataflow_nomain.o: ${OBJECTDIR}/dataflow.o dataflow.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dataflow_nomain.o dataflow.cpp;\
	else  \
...
${OBJECTDIR}/dataset_nomain.o: ${OBJECTDIR}/dataset.o dataset.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dataset_nomain.o dataset.cpp;\
	else  \
...
${OBJECTDIR}/dependency_nomain.o: ${OBJECTDIR}/dependency.o dependency.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dependency_nomain.o dependency.cpp;\
	else  \
...
${OBJECTDIR}/element_nomain.o: ${OBJECTDIR}/element.o element.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/element_nomain.o element.cpp;\
	else  \
...
${OBJECTDIR}/extractor_nomain.o: ${OBJECTDIR}/extractor.o extractor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/extractor_nomain.o extractor.cpp;\
	else  \
...
${OBJECTDIR}/set_nomain.o: ${OBJECTDIR}/set.o set.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/set_nomain.o set.cpp;\
	else  \
...
${OBJECTDIR}/task_nomain.o: ${OBJECTDIR}/task.o task.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/task_nomain.o task.cpp;\
	else  \
...
${OBJECTDIR}/transformation_nomain.o: ${OBJECTDIR}/transformation.o transformation.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/transformation_nomain.o transformation.cpp;\
	else  \
